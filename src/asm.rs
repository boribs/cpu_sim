...
mod read_from_mem {
    ...
    fn read_cmp() {
        ...
        let expected = [
            (Instruction::Cmp(CR::Register(Reg::A), Reg::B), 3),
            (Instruction::Cmp(CR::Constant(0xab), Reg::AL), 4),
        ];
    ...
    fn read_jne() {
        ...
        let expected = [
            (Instruction::Jne(CR::Register(Reg::A)), 2),
            (Instruction::Jne(CR::Constant(0xab)), 3),
        ];
    ...
    fn read_push() {
        ...
        let expected = [
            (Instruction::Push(CR::Register(Reg::A)), 2),
            (Instruction::Push(CR::Constant(0xab)), 3),
        ];
